...
const BookInfo: React.FC<Props> = ({ book }) => {
  ...
  return (
    <div
      className="!bg-card border border-primary/20 rounded-lg overflow-hidden cursor-pointer flex flex-col"
    ...
    >
      ...
      />
      <div className="px-4 pb-4 pt-2 flex flex-col justify-between h-full">
        <div>
